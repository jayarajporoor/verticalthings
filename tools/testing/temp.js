...
function evaluateifblock(jdata){
...
modules.forEach(function(modname){
    ...
    mod['fdefs'].forEach(function(func){
        ...
        func['body']['stmts'].forEach(function(stat){
            if ((stat['kind'] == "if")){
                time += evaluateifblock(stat['body']);
            }
            if (stat['kind'] == "for" || stat['kind'] == "while"){
                time += evaluatefor(stat['body']);
            }
            if ((stat['kind'] == "for" || stat['kind'] == "while") && checkstat(stat['ids'])){
                time += evaluateforcompiler(stat['body']);
            }
            // if ((stat['kind'] == "for" || stat['kind'] == "while") && checkstat(stat['ids'])){  
