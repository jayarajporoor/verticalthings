...
//#include "sr/c/utils.h"
//#include "src/f/eatureextraction.h"
//#include "src/pred/ictionfilter.h"
...
typedef enum { __mpu_acq_test_mpu_acq}  __pipe;
    ...
    VectorInt16 mpu_acq_test_mpu_acq_acc__, mpu_acq_test_mpu_acq_gyr__;
    {
        ...
        if((mpu_acq_test_mpu_acq_mpuIntStatus&2))
        {
            if((mpu_acq_test_mpu_acq_fifoCount>=mpu_acq_test_fifoPacketSize))
            {
                ...
                Serial.write(mpu_acq_test_mpu_acq_acc[mpu_acq_test_x]);
                Serial.write(mpu_acq_test_mpu_acq_acc[mpu_acq_test_y]);
                Serial.write(mpu_acq_test_mpu_acq_acc[mpu_acq_test_z]);
                Serial.write(mpu_acq_test_mpu_acq_gyr[mpu_acq_test_x]);
                Serial.write(mpu_acq_test_mpu_acq_gyr[mpu_acq_test_y]);
                Serial.write(mpu_acq_test_mpu_acq_gyr[mpu_acq_test_z]);
            }
        }
    }
}
