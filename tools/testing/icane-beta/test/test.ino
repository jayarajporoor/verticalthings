...
float (*tlcfeaturizer_test_featureVectorF_p)[124]= (float (*)[124]) &__vtmem[2410];
#define tlcfeaturizer_test_featureVectorF (*tlcfeaturizer_test_featureVectorF_p)
float (*protonn_test_predict_x_cap_p)[10]= (float (*)[10]) &__vtmem[2534];
...
void _protonn_test_predict()
{
    ...
    float __t4;
    {
        ...
        for(int i=0; i<protonn_test_numPrototypes; i++)
        {
            ...
            //if(__t3 != 0)
              //         Serial.println(__t3/3.402823e+15);
