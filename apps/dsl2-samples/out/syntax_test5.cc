 ...
 lstate_0:
{
    ...
    _this->_arec__sys_HAL_io_completion._state = 0;
    _this->_arec__sys_HAL_io_completion.sys_HAL_io_completion_io = _this->syntax_test5_acq_rcomm;
 lstate_1:
    _state = _sys_HAL_io_completion( &(_this->_arec__sys_HAL_io_completion)) ;
...
if (_state > 0 && _state <= 1) goto *(_atbl[_state]);
 lstate_0:
{
    _this->_arec__syntax_test5_acq._state = 0;
    _this->_arec__syntax_test5_acq.syntax_test5_acq_y = 3;
    _this->_arec__syntax_test5_acq.syntax_test5_acq_comm = _this->syntax_test5_main_spi;
    _syntax_test5_acq( &(_this->_arec__syntax_test5_acq), ((float*) 0UL)) ;
    syntax_test5_facq._parec = &(_this->_arec__syntax_test5_acq);
