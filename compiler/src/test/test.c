...
undefined (*mpu_acq_fifoBuffer_p)[64]= (undefined (*)[64]) &__vtmem[0];
...
void _mpu_acq_init(undefined mpu_acq_init_i2c_arduino)
{
{
...
mpu_acq_mpu1.init();
mpu_acq_mpu1.dmpInitialize();
mpu_acq_mpu1.setDMPEnabled(true);
fifoPacketSize=mpu_acq_mpu1.dmpGetFIFOPacketSize();
}
}
void _mpu_acq_acq()
{
