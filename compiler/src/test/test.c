...
float (*normalize_inp_test_normalize_normAcc_p)[3]= (float (*)[3]) &__vtmem[8026];
#define normalize_inp_test_normalize_normAcc (*normalize_inp_test_normalize_normAcc_p)
float (*normalize_inp_test_normalize_normGyr_p)[3]= (float (*)[3]) &__vtmem[8028];
#define normalize_inp_test_normalize_normGyr (*normalize_inp_test_normalize_normGyr_p)
int (*tlcfeaturizer_test_featurizer_featureVector_p)[124]= (int (*)[124]) &__vtmem[8030];
#define tlcfeaturizer_test_featurizer_featureVector (*tlcfeaturizer_test_featurizer_featureVector_p)
float (*tlcfeaturizer_test_featurizer_featureVectorF_p)[124]= (float (*)[124]) &__vtmem[8032];
#define tlcfeaturizer_test_featurizer_featureVectorF (*tlcfeaturizer_test_featurizer_featureVectorF_p)
...
{
    int tlcfeaturizer_test_featurizer_result;
    {
        ...
        _tlcfeaturizer_test_getBucket(tlcfeaturizer_test_featurizer_normAZ, tlcfeaturizer_test_featurizer___pos_normAZ, tlcfeaturizer_test_featurizer_featureVector, true);
        _tlcfeaturizer_test_getBucket(tlcfeaturizer_test_featurizer_normGX, tlcfeaturizer_test_featurizer___pos_normGX, tlcfeaturizer_test_featurizer_featureVector, true);
        _tlcfeaturizer_test_getBucket(tlcfeaturizer_test_featurizer_normGY, tlcfeaturizer_test_featurizer___pos_normGY, tlcfeaturizer_test_featurizer_featureVector, true);
        _tlcfeaturizer_test_getBucket(tlcfeaturizer_test_featurizer_normGZ, tlcfeaturizer_test_featurizer___pos_normGZ, tlcfeaturizer_test_featurizer_featureVector, true);
        for(int __i=0; __i<124; __i++)
        {
            tlcfeaturizer_test_featurizer_featureVectorF[__i]=tlcfeaturizer_test_featurizer_featureVector[__i];
        }
    }
}
void _tlcfeaturizer_test_getBucket(float tlcfeaturizer_test_getBucket_sensorValue1D[400], int tlcfeaturizer_test_getBucket___pos_sensorValue1D, int tlcfeaturizer_test_getBucket_bucketDistribution[tlcfeaturizer_test_FEATURE_LENGTH], boolean tlcfeaturizer_test_getBucket_isGY)
{
    ...
    float tlcfeaturizer_test_getBucket_j, tlcfeaturizer_test_getBucket_k;
    {
        for(int i=0; i<400; i++)
        {
            ...
            {
                tlcfeaturizer_test_getBucket_bucketDistribution[tlcfeaturizer_test_bucketIndex]=(tlcfeaturizer_test_getBucket_bucketDistribution[tlcfeaturizer_test_bucketIndex]+1);
            }
            else
            if((tlcfeaturizer_test_getBucket_val>100))
            {
                tlcfeaturizer_test_getBucket_bucketDistribution[(tlcfeaturizer_test_bucketIndex+19)]=(tlcfeaturizer_test_getBucket_bucketDistribution[(tlcfeaturizer_test_bucketIndex+19)]+1);
            }
            else
            {
                tlcfeaturizer_test_getBucket_index=(tlcfeaturizer_test_getBucket_val/5);
                tlcfeaturizer_test_getBucket_bucketDistribution[(tlcfeaturizer_test_bucketIndex+tlcfeaturizer_test_getBucket_index)]=(tlcfeaturizer_test_getBucket_bucketDistribution[(tlcfeaturizer_test_bucketIndex+tlcfeaturizer_test_getBucket_index)]+1);
            }
            if((tlcfeaturizer_test_getBucket_isGY==1))
            {
                ...
                if(((tlcfeaturizer_test_getBucket_val>62)&&(tlcfeaturizer_test_getBucket_flagPos==1)))
                {
                    ...
                    if((tlcfeaturizer_test_getBucket_maxcount>tlcfeaturizer_test_getBucket_maxval))
                    {
                        ...
                        {
                            tlcfeaturizer_test_getBucket_bucketDistribution[1]=tlcfeaturizer_test_getBucket_maxval;
                        }
                        tlcfeaturizer_test_getBucket_imax=tlcfeaturizer_test_getBucket_postemp;
                        if((tlcfeaturizer_test_getBucket_maxval>tlcfeaturizer_test_getBucket_thresholdCount))
                        {
                            tlcfeaturizer_test_getBucket_bucketDistribution[0]=tlcfeaturizer_test_getBucket_imax;
                        }
                    }
                }
                else
                ...
                if(((tlcfeaturizer_test_getBucket_val<32)&&(tlcfeaturizer_test_getBucket_flagNeg==1)))
                {
                    ...
                    if((tlcfeaturizer_test_getBucket_mincount>tlcfeaturizer_test_getBucket_minval))
                    {
                        ...
                        {
                            tlcfeaturizer_test_getBucket_bucketDistribution[2]=tlcfeaturizer_test_getBucket_minval;
                        }
                        tlcfeaturizer_test_getBucket_imin=tlcfeaturizer_test_getBucket_negtemp;
                        if((tlcfeaturizer_test_getBucket_minval>tlcfeaturizer_test_getBucket_thresholdCount))
                        {
                            tlcfeaturizer_test_getBucket_bucketDistribution[3]=tlcfeaturizer_test_getBucket_imin;
                        }
                    }
                }
                else
        ...
        bucktIndex=(tlcfeaturizer_test_bucketIndex+bucketWidth);
    }
}
void loop()
{
