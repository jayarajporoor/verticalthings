...
{
    {
        ...
        Serial.print(mpu_acq_test_mpu_acq_acc[mpu_acq_test_x]);
        Serial.print(mpu_acq_test_mpu_acq_acc[mpu_acq_test_y]);
        Serial.print(mpu_acq_test_mpu_acq_acc[mpu_acq_test_z]);
        Serial.print(mpu_acq_test_mpu_acq_gyr[mpu_acq_test_x]);
        Serial.print(mpu_acq_test_mpu_acq_gyr[mpu_acq_test_y]);
        Serial.print(mpu_acq_test_mpu_acq_gyr[mpu_acq_test_z]);
...
{
    {
        ...
        if((normalize_inp_test_normalize_numNewReadings==normalize_inp_test_STRIDE))
        {
            ...
            Serial.print(normalize_inp_test_normAX[ ( (0) + normalize_inp_test___pos_normAX) % 400]);
            Serial.print(normalize_inp_test_normAY[ ( (0) + normalize_inp_test___pos_normAY) % 400]);
            Serial.print(normalize_inp_test_normAZ[ ( (0) + normalize_inp_test___pos_normAZ) % 400]);
            Serial.print(normalize_inp_test_normGX[ ( (0) + normalize_inp_test___pos_normGX) % 400]);
            Serial.print(normalize_inp_test_normGY[ ( (0) + normalize_inp_test___pos_normGY) % 400]);
            Serial.print(normalize_inp_test_normGZ[ ( (0) + normalize_inp_test___pos_normGZ) % 400]);
        }
    }
}
void loop()
