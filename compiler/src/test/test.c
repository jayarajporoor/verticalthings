...
int (*test_mod_acquire_rbuf_p)[10]= (int (*)[10]) &__vtmem[60];
#define test_mod_acquire_rbuf (*test_mod_acquire_rbuf_p)
int (*test_mod_acquire_zbuf_p)[10]= (int (*)[10]) &__vtmem[60];
#define test_mod_acquire_zbuf (*test_mod_acquire_zbuf_p)
int (*test_mod_acquire_ybuf_p)[10]= (int (*)[10]) &__vtmem[100];
...
void _test_mod_acquire()
{
    ...
    int __t1;
    {
        ...
        {
            test_mod_acquire_rbuf[ ( (__i) + test_mod_acquire___pos_rbuf) % 10]=0;
            __t0=0;
...
int _test_mod2_compute(int test_mod2_compute_val[10], int test_mod2_compute___pos_val, int test_mod2_compute_scale)
{
    ...
    int __t0;
    {
        ...
        for(int __i=0; __i<10; __i++)
        {
            __t0=((test_mod2_compute_val[ ( (__i) + test_mod2_compute___pos_val) % 10]*test_mod2_factors[__i])+__t0);
        }
