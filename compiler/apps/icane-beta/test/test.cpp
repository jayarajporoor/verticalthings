...
float (*protonn_test_predict_y_cap_p)[10]= (float (*)[10]) &__vtmem[10120];
#define protonn_test_predict_y_cap (*protonn_test_predict_y_cap_p)
float (*tlcfeaturizer_test_featureVectorF_p)[124]= (float (*)[124]) &__vtmem[10160];
#define tlcfeaturizer_test_featureVectorF (*tlcfeaturizer_test_featureVectorF_p)
float (*normalize_inp_test_normalize_normAcc_p)[3]= (float (*)[3]) &__vtmem[10160];
#define normalize_inp_test_normalize_normAcc (*normalize_inp_test_normalize_normAcc_p)
float (*normalize_inp_test_normalize_normGyr_p)[3]= (float (*)[3]) &__vtmem[10160];
#define normalize_inp_test_normalize_normGyr (*normalize_inp_test_normalize_normGyr_p)
int16_t (*mpu_acq_test_mpu_acq_gyr_p)[3]= (int16_t (*)[3]) &__vtmem[10160];
#define mpu_acq_test_mpu_acq_gyr (*mpu_acq_test_mpu_acq_gyr_p)
float (*protonn_test_predict_x_cap_p)[10]= (float (*)[10]) &__vtmem[10172];
...
const int16_t protonn_test_BAUD_RATE=115200;
...
float (*protonn_test_predict_x_p)[protonn_test_FEATURE_LENGTH];
...
void _protonn_test_predict()
{
    ...
    float __t4;
    {
        ...
        {
            __t0=0;
            for(int __j=0; __j<; __j++)
            {
                __t0=((protonn_test_predict_x[__j]*protonn_test_ldProjectionMatrix[__j][__i])+__t0);
            }
        }
        for(int __i=0; __i<10; __i++)
        {
        ...
        protonn_test_predict_maxScore=(-FLT_MAX);
