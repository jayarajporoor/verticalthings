...
uint8_t (*mpu_acq_test_fifoBuffer_p)[64]= (uint8_t (*)[64]) &__vtmem[2530];
#define mpu_acq_test_fifoBuffer (*mpu_acq_test_fifoBuffer_p)
int16_t (*mpu_acq_test_mpu_acq_acc_p)[3]= (int16_t (*)[3]) &__vtmem[2530];
#define mpu_acq_test_mpu_acq_acc (*mpu_acq_test_mpu_acq_acc_p)
float (*protonn_test_predict_y_cap_p)[10]= (float (*)[10]) &__vtmem[2530];
#define protonn_test_predict_y_cap (*protonn_test_predict_y_cap_p)
float (*tlcfeaturizer_test_featureVectorF_p)[124]= (float (*)[124]) &__vtmem[2540];
#define tlcfeaturizer_test_featureVectorF (*tlcfeaturizer_test_featureVectorF_p)
float (*normalize_inp_test_normalize_normAcc_p)[3]= (float (*)[3]) &__vtmem[2540];
#define normalize_inp_test_normalize_normAcc (*normalize_inp_test_normalize_normAcc_p)
float (*normalize_inp_test_normalize_normGyr_p)[3]= (float (*)[3]) &__vtmem[2540];
#define normalize_inp_test_normalize_normGyr (*normalize_inp_test_normalize_normGyr_p)
int16_t (*mpu_acq_test_mpu_acq_gyr_p)[3]= (int16_t (*)[3]) &__vtmem[2540];
#define mpu_acq_test_mpu_acq_gyr (*mpu_acq_test_mpu_acq_gyr_p)
float (*protonn_test_predict_x_cap_p)[10]= (float (*)[10]) &__vtmem[2543];
