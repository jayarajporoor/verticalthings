...
VerticalThings.prototype.funcDef = function() {
    ...
    try {
        ...
        this.state = 391;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VerticalThings.FUTURE) | (1 << VerticalThings.RCHAN) | (1 << VerticalThings.CHAN) | (1 << VerticalThings.CONST) | (1 << VerticalThings.VOID) | (1 << VerticalThings.LP) | (1 << VerticalThings.LS))) !== 0) || ((((_la - 62)) & ~0x1f) == 0 && ((1 << (_la - 62)) & ((1 << (VerticalThings.INT - 62)) | (1 << (VerticalThings.FLOAT - 62)) | (1 << (VerticalThings.BOOLEAN - 62)) | (1 << (VerticalThings.I8 - 62)) | (1 << (VerticalThings.U8 - 62)) | (1 << (VerticalThings.I16 - 62)) | (1 << (VerticalThings.U16 - 62)) | (1 << (VerticalThings.I32 - 62)) | (1 << (VerticalThings.U32 - 62)) | (1 << (VerticalThings.Identifier - 62)))) !== 0)) {
            this.state = 390;
            this.formalParams();
        }
