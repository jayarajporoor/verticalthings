...
VerticalThings.RETURN = 55;
VerticalThings.Identifier = 56;
VerticalThings.IntegerConstant = 57;
VerticalThings.FloatingConstant = 58;
VerticalThings.DigitSequence = 59;
VerticalThings.CharacterConstant = 60;
VerticalThings.StringLiteral = 61;
VerticalThings.Whitespace = 62;
VerticalThings.Newline = 63;
VerticalThings.BlockComment = 64;
VerticalThings.LineComment = 65;
...
VerticalThings.prototype.arrayLiteral = function() {
    ...
    try {
        ...
        this.state = 157;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VerticalThings.TRUE) | (1 << VerticalThings.FALSE) | (1 << VerticalThings.LB))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (VerticalThings.IntegerConstant - 57)) | (1 << (VerticalThings.FloatingConstant - 57)) | (1 << (VerticalThings.CharacterConstant - 57)) | (1 << (VerticalThings.StringLiteral - 57)))) !== 0)) {
            this.state = 149;
            this.literal();
            this.state = 154;
            this._errHandler.sync(this);
