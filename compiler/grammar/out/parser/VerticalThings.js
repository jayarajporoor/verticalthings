...
var symbolicNames = [ null, "MODULE", "PIPELINE", "FLOW", "USE", "CONFIG", 
                      ...
                      "ASSIGN", "PLUSASSIGN", "MINUSASSIGN", "MULASSIGN", 
                      "INC", "DEC", "LAND", "LOR", "LNOT", "LSHIFT", "RSHIFT", 
                      "BAND", "BOR", "BNOT", "BXOR", "INT", "FLOAT", "BOOLEAN", 
                      "RETURN", "Identifier", "IntegerConstant", "FloatingConstant", 
...
VerticalThings.PLUSASSIGN = 43;
VerticalThings.MINUSASSIGN = 44;
VerticalThings.MULASSIGN = 45;
VerticalThings.INC = 46;
VerticalThings.DEC = 47;
...
VerticalThings.INT = 57;
VerticalThings.FLOAT = 58;
VerticalThings.BOOLEAN = 59;
VerticalThings.RETURN = 60;
VerticalThings.Identifier = 61;
VerticalThings.IntegerConstant = 62;
VerticalThings.FloatingConstant = 63;
VerticalThings.DigitSequence = 64;
VerticalThings.CharacterConstant = 65;
VerticalThings.StringLiteral = 66;
VerticalThings.Whitespace = 67;
VerticalThings.Newline = 68;
VerticalThings.BlockComment = 69;
VerticalThings.LineComment = 70;
...
VerticalThings.RULE_flowType = 20;
VerticalThings.RULE_formalParam = 21;
VerticalThings.RULE_formalParams = 22;
VerticalThings.RULE_stmtBlock = 23;
VerticalThings.RULE_elseStmt = 24;
VerticalThings.RULE_ifStmt = 25;
VerticalThings.RULE_identifierList = 26;
VerticalThings.RULE_forStmt = 27;
VerticalThings.RULE_whileStmt = 28;
VerticalThings.RULE_assignStmt = 29;
VerticalThings.RULE_returnStmt = 30;
VerticalThings.RULE_stmt = 31;
VerticalThings.RULE_funcDef = 32;
VerticalThings.RULE_qualIdentifier = 33;
VerticalThings.RULE_cppQualIdentifier = 34;
VerticalThings.RULE_functionCall = 35;
VerticalThings.RULE_actualParam = 36;
VerticalThings.RULE_actualParams = 37;
VerticalThings.RULE_arrayExpr = 38;
VerticalThings.RULE_castExpr = 39;
VerticalThings.RULE_basicExpr = 40;
VerticalThings.RULE_relExpr = 41;
VerticalThings.RULE_expr = 42;
VerticalThings.RULE_numConstant = 43;
VerticalThings.RULE_exprConstant = 44;
VerticalThings.RULE_literal = 45;
...
VerticalThings.prototype.module = function() {
    ...
    try {
        ...
        case VerticalThings.Identifier:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VerticalThings.FLOW) | (1 << VerticalThings.DEFAULT) | (1 << VerticalThings.VOID) | (1 << VerticalThings.LS))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (VerticalThings.INT - 57)) | (1 << (VerticalThings.FLOAT - 57)) | (1 << (VerticalThings.BOOLEAN - 57)) | (1 << (VerticalThings.Identifier - 57)))) !== 0)) {
                this.state = 107;
                this.funcDef();
                this.state = 112;
                this._errHandler.sync(this);
...
VerticalThings.prototype.arrayLiteral = function() {
    ...
    try {
        ...
        this.state = 157;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VerticalThings.TRUE) | (1 << VerticalThings.FALSE) | (1 << VerticalThings.LB))) !== 0) || ((((_la - 62)) & ~0x1f) == 0 && ((1 << (_la - 62)) & ((1 << (VerticalThings.IntegerConstant - 62)) | (1 << (VerticalThings.FloatingConstant - 62)) | (1 << (VerticalThings.CharacterConstant - 62)) | (1 << (VerticalThings.StringLiteral - 62)))) !== 0)) {
            this.state = 149;
            this.literal();
            this.state = 154;
            this._errHandler.sync(this);
...
VerticalThings.prototype.varDef = function() {
    ...
    this.enterRule(localctx, 20, VerticalThings.RULE_varDef);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 172;
...
VerticalThings.prototype.dimExpr = function() {
    ...
    this.enterRule(localctx, 22, VerticalThings.RULE_dimExpr);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 185;
...
VerticalThings.prototype.castableType = function() {
    ...
    try {
        ...
        this.state = 217;
        _la = this._input.LA(1);
        if(!(((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (VerticalThings.INT - 57)) | (1 << (VerticalThings.FLOAT - 57)) | (1 << (VerticalThings.BOOLEAN - 57)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
...
VerticalThings.prototype.primitiveType = function() {
    ...
    try {
        ...
        this.state = 219;
        _la = this._input.LA(1);
        if(!(_la===VerticalThings.VOID || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (VerticalThings.INT - 57)) | (1 << (VerticalThings.FLOAT - 57)) | (1 << (VerticalThings.BOOLEAN - 57)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
...
VerticalThings.prototype.flowType = function() {
    ...
    this.enterRule(localctx, 40, VerticalThings.RULE_flowType);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 231;
...
VerticalThings.prototype.formalParam = function() {
    ...
    this.enterRule(localctx, 42, VerticalThings.RULE_formalParam);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 236;
...
VerticalThings.prototype.formalParams = function() {
    ...
    this.enterRule(localctx, 44, VerticalThings.RULE_formalParams);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 241;
...
VerticalThings.prototype.stmtBlock = function() {
    ...
    this.enterRule(localctx, 46, VerticalThings.RULE_stmtBlock);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 249;
...
VerticalThings.prototype.elseStmt = function() {
    ...
    this.enterRule(localctx, 48, VerticalThings.RULE_elseStmt);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 258;
...
VerticalThings.prototype.ifStmt = function() {
    ...
    this.enterRule(localctx, 50, VerticalThings.RULE_ifStmt);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 263;
...
VerticalThings.prototype.identifierList = function() {
    ...
    this.enterRule(localctx, 52, VerticalThings.RULE_identifierList);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 271;
...
VerticalThings.prototype.forStmt = function() {
    ...
    this.enterRule(localctx, 54, VerticalThings.RULE_forStmt);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 279;
...
VerticalThings.prototype.whileStmt = function() {
    ...
    this.enterRule(localctx, 56, VerticalThings.RULE_whileStmt);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 285;
...
VerticalThings.prototype.assignStmt = function() {
    ...
    this.enterRule(localctx, 58, VerticalThings.RULE_assignStmt);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 291;
...
VerticalThings.prototype.returnStmt = function() {
    ...
    this.enterRule(localctx, 60, VerticalThings.RULE_returnStmt);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 298;
...
VerticalThings.prototype.stmt = function() {
    ...
    this.enterRule(localctx, 62, VerticalThings.RULE_stmt);
    try {
        this.state = 314;
        this._errHandler.sync(this);
...
VerticalThings.prototype.funcDef = function() {
    ...
    this.enterRule(localctx, 64, VerticalThings.RULE_funcDef);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 318;
        ...
        this.state = 323;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VerticalThings.CONST) | (1 << VerticalThings.VOID) | (1 << VerticalThings.LS))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (VerticalThings.INT - 57)) | (1 << (VerticalThings.FLOAT - 57)) | (1 << (VerticalThings.BOOLEAN - 57)) | (1 << (VerticalThings.Identifier - 57)))) !== 0)) {
            this.state = 322;
            this.formalParams();
        }
...
VerticalThings.prototype.qualIdentifier = function() {
    ...
    this.enterRule(localctx, 66, VerticalThings.RULE_qualIdentifier);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 341;
        this.match(VerticalThings.Identifier);
...
VerticalThings.prototype.cppQualIdentifier = function() {
    ...
    this.enterRule(localctx, 68, VerticalThings.RULE_cppQualIdentifier);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 349;
...
VerticalThings.prototype.functionCall = function() {
    ...
    this.enterRule(localctx, 70, VerticalThings.RULE_functionCall);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 358;
        ...
        this.state = 362;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VerticalThings.TRUE) | (1 << VerticalThings.FALSE) | (1 << VerticalThings.LP) | (1 << VerticalThings.MINUS))) !== 0) || ((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (VerticalThings.LNOT - 50)) | (1 << (VerticalThings.BNOT - 50)) | (1 << (VerticalThings.INT - 50)) | (1 << (VerticalThings.FLOAT - 50)) | (1 << (VerticalThings.BOOLEAN - 50)) | (1 << (VerticalThings.Identifier - 50)) | (1 << (VerticalThings.IntegerConstant - 50)) | (1 << (VerticalThings.FloatingConstant - 50)) | (1 << (VerticalThings.CharacterConstant - 50)) | (1 << (VerticalThings.StringLiteral - 50)))) !== 0)) {
            this.state = 361;
            this.actualParams();
        }
...
VerticalThings.prototype.actualParam = function() {
    ...
    this.enterRule(localctx, 72, VerticalThings.RULE_actualParam);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 368;
        this._errHandler.sync(this);
...
VerticalThings.prototype.actualParams = function() {
    ...
    this.enterRule(localctx, 74, VerticalThings.RULE_actualParams);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 374;
...
VerticalThings.prototype.arrayExpr = function() {
    ...
    this.enterRule(localctx, 76, VerticalThings.RULE_arrayExpr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 385;
        this.match(VerticalThings.Identifier);
...
VerticalThings.prototype.castExpr = function() {
    ...
    this.enterRule(localctx, 78, VerticalThings.RULE_castExpr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 388;
        this.castableType();
...
VerticalThings.prototype.basicExpr = function(_p) {
    ...
    var _startState = 80;
    this.enterRecursionRule(localctx, 80, VerticalThings.RULE_basicExpr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 405;
...
VerticalThings.prototype.relExpr = function() {
    ...
    this.enterRule(localctx, 82, VerticalThings.RULE_relExpr);
    var _la = 0; // Token type
    try {
        this.state = 438;
        this._errHandler.sync(this);
...
VerticalThings.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 84;
    this.enterRecursionRule(localctx, 84, VerticalThings.RULE_expr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 449;
...
VerticalThings.prototype.numConstant = function() {
    ...
    this.enterRule(localctx, 86, VerticalThings.RULE_numConstant);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 459;
...
VerticalThings.prototype.exprConstant = function() {
    ...
    this.enterRule(localctx, 88, VerticalThings.RULE_exprConstant);
    try {
        this.state = 464;
        switch(this._input.LA(1)) {
        case VerticalThings.IntegerConstant:
...
VerticalThings.prototype.literal = function() {
    ...
    this.enterRule(localctx, 90, VerticalThings.RULE_literal);
    try {
        this.state = 469;
        switch(this._input.LA(1)) {
        case VerticalThings.TRUE:
