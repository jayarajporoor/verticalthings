...
VerticalThings.RULE_stmt = 30;
VerticalThings.RULE_funcDef = 31;
VerticalThings.RULE_qualIdentifier = 32;
VerticalThings.RULE_cppQualIdentifier = 33;
VerticalThings.RULE_functionCall = 34;
VerticalThings.RULE_actualParam = 35;
VerticalThings.RULE_actualParams = 36;
VerticalThings.RULE_arrayExpr = 37;
VerticalThings.RULE_castExpr = 38;
VerticalThings.RULE_basicExpr = 39;
VerticalThings.RULE_relExpr = 40;
VerticalThings.RULE_expr = 41;
VerticalThings.RULE_numConstant = 42;
VerticalThings.RULE_exprConstant = 43;
VerticalThings.RULE_literal = 44;
...
VerticalThings.prototype.stmt = function() {
    ...
    this.enterRule(localctx, 60, VerticalThings.RULE_stmt);
    try {
        this.state = 306;
        this._errHandler.sync(this);
...
VerticalThings.prototype.funcDef = function() {
    ...
    this.enterRule(localctx, 62, VerticalThings.RULE_funcDef);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 310;
...
VerticalThings.prototype.qualIdentifier = function() {
    ...
    this.enterRule(localctx, 64, VerticalThings.RULE_qualIdentifier);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 333;
        this.match(VerticalThings.Identifier);
...
VerticalThings.prototype.cppQualIdentifier = function() {
    ...
    this.enterRule(localctx, 66, VerticalThings.RULE_cppQualIdentifier);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 341;
...
VerticalThings.prototype.functionCall = function() {
    ...
    this.enterRule(localctx, 68, VerticalThings.RULE_functionCall);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 350;
...
VerticalThings.prototype.actualParam = function() {
    ...
    this.enterRule(localctx, 70, VerticalThings.RULE_actualParam);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 360;
        this._errHandler.sync(this);
...
VerticalThings.prototype.actualParams = function() {
    ...
    this.enterRule(localctx, 72, VerticalThings.RULE_actualParams);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 366;
...
VerticalThings.prototype.arrayExpr = function() {
    ...
    this.enterRule(localctx, 74, VerticalThings.RULE_arrayExpr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 377;
        this.match(VerticalThings.Identifier);
...
VerticalThings.prototype.castExpr = function() {
    ...
    this.enterRule(localctx, 76, VerticalThings.RULE_castExpr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 380;
        this.castableType();
...
VerticalThings.prototype.basicExpr = function(_p) {
    ...
    var _startState = 78;
    this.enterRecursionRule(localctx, 78, VerticalThings.RULE_basicExpr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 397;
...
VerticalThings.prototype.relExpr = function() {
    ...
    this.enterRule(localctx, 80, VerticalThings.RULE_relExpr);
    var _la = 0; // Token type
    try {
        this.state = 430;
        this._errHandler.sync(this);
...
VerticalThings.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 82;
    this.enterRecursionRule(localctx, 82, VerticalThings.RULE_expr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 441;
...
VerticalThings.prototype.numConstant = function() {
    ...
    this.enterRule(localctx, 84, VerticalThings.RULE_numConstant);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 451;
...
VerticalThings.prototype.exprConstant = function() {
    ...
    this.enterRule(localctx, 86, VerticalThings.RULE_exprConstant);
    try {
        this.state = 456;
        switch(this._input.LA(1)) {
        case VerticalThings.IntegerConstant:
...
VerticalThings.prototype.literal = function() {
    ...
    this.enterRule(localctx, 88, VerticalThings.RULE_literal);
    try {
        this.state = 461;
        switch(this._input.LA(1)) {
        case VerticalThings.TRUE:
